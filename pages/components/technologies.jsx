...
export default function Technologies(props) {
  ...
  return (
    <div className='flex flex-col items-start justify-start w-full space-y-2'>
      <motion.div className='flex flex-col items-start justify-start w-full space-y-1' initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.8 }}>
      ...
      <motion.div className='grid grid-cols-2 md:grid-cols-4 gap-y-0.5 w-full' initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 1.2 }}>
